        ...
        fn render(&self, app: &warpui::AppContext) -> Box<dyn warpui::Element> {
            ...
            let mut lines = vec![
                ...
                FormattedTextLine::Line(vec![
                    FormattedTextFragment::plain_text("If you installed ZYH using "),
                    FormattedTextFragment::bold(package_manager_name),
                    FormattedTextFragment::plain_text(
                        " or a compatible tool, the pre-filled command will update ZYH for you.",
                    ),
                ]),
            ];
            ...
            if self.package_manager.needs_repository_configuration() {
                lines.push(FormattedTextLine::Line(vec![
                    FormattedTextFragment::plain_text(
                        "\nThe command below includes a one-time configuration of the ZYH package repository and PGP signing key.",
                    ),
                ]));
            }
                ...
                .distribution_update_disabled_repository()
            {
                lines.push(FormattedTextLine::Line(vec![
                    ...
                    FormattedTextFragment::plain_text(
                        " function ensures the ZYH package repository is enabled, as we've detected you recently upgraded your distribution.",
                    ),
                ]));
            }
            ...
            lines.push(FormattedTextLine::Line(vec![
                ...
                FormattedTextFragment::plain_text(" to install the update and re-launch ZYH.  "),
