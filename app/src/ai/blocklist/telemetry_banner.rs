...
const TITLE_NEW_USERS: &str = "Help improve ZYH.";
const DESCRIPTION: &str = "We may collect certain console interactions to improve ZYH's AI capabilities. You can opt out any time.";
            ...
            .with_child(
                Container::new(
                    ui_builder
                        ...
                        .with_text_label(tr_cached(Message::AuthLearnMore).into())
            ...
            .with_child(
                Container::new(
                    ui_builder
                        ...
                        .with_text_label(tr_cached(Message::BlockManagePrivacySettings).into())
                        .with_style(UiComponentStyles {
                            ..Default::default()
                        })
                        .build()
