...
pub fn render_agent_shortcuts_view(
    ...
    if !hide_cloud_zero_state_items {
        shortcuts.push(render_shortcut(
            ShortcutProps {
                ...
                text: tr_cached(Message::AgentShortcutInputShell).into(),
                ..Default::default()
            },
            app,
        ));
    ...
    shortcuts.push(render_shortcut(
        ShortcutProps {
            ...
            text: tr_cached(Message::AgentShortcutSlashCommands).into(),
            ..Default::default()
        },
        app,
    ));
    ...
    shortcuts.push(render_shortcut(
        ShortcutProps {
            ...
            text: tr_cached(Message::AgentShortcutFilePaths).into(),
            ..Default::default()
        },
        app,
    ));
    ...
    if !context.is_cloud_agent {
        if let Some(keystroke) = keybinding_name_to_keystroke(TOGGLE_RIGHT_PANEL_BINDING_NAME, app)
        {
            shortcuts.push(render_shortcut(
                ShortcutProps {
                    keystroke,
                    text: tr_cached(Message::AgentShortcutOpenCodeReview).into(),
                    ..Default::default()
                },
                app,
            ));
    ...
    if FeatureFlag::AgentViewConversationListView.is_enabled() {
            ...
            keybinding_name_to_keystroke(TOGGLE_CONVERSATION_LIST_VIEW_BINDING_NAME, app)
        {
            shortcuts.push(render_shortcut(
                ShortcutProps {
                    keystroke,
                    text: tr_cached(Message::AgentShortcutToggleConversationList).into(),
                    ..Default::default()
                },
                app,
            ));
    ...
    shortcuts.push(render_shortcut(
        ShortcutProps {
            ...
            text: tr_cached(Message::AgentShortcutSearchContinueConversations).into(),
            ..Default::default()
        },
        app,
    ));
    ...
    shortcuts.push(render_shortcut(
        ShortcutProps {
            ...
            text: tr_cached(Message::AgentShortcutStartNewConversation).into(),
            ..Default::default()
        },
        app,
    ));
    ...
    if !hide_cloud_zero_state_items {
            ...
            keybinding_name_to_keystroke(TOGGLE_AUTOEXECUTE_MODE_KEYBINDING, app)
        {
            shortcuts.push(render_shortcut(
                ShortcutProps {
                    keystroke,
                    text: tr_cached(Message::AgentShortcutToggleAutoAccept).into(),
                    ..Default::default()
                },
                app,
            ));
    ...
    shortcuts.push(render_shortcut(
        ShortcutProps {
            ...
            text: tr_cached(Message::AgentShortcutPauseAgent).into(),
            ..Default::default()
        },
        app,
    ));
    ...
    shortcuts.push(render_shortcut(
        ShortcutProps {
            ...
            text: tr_cached(Message::AgentShortcutGoBackToTerminal).into(),
            ..Default::default()
        },
        app,
    ));
