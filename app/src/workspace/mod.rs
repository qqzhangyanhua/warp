...
pub fn init(app: &mut AppContext) {
        ...
        #[cfg(debug_assertions)]
        {
            ...
            app.register_editable_bindings([
                ...
                EditableBinding::new(
                    ...
                    "[Debug] Install OpenCode ZYH plugin",
    ...
    app.register_editable_bindings([
        ...
        EditableBinding::new(
            ...
            BindingDescription::new("Left Panel: ZYH Drive"),
        ...
        EditableBinding::new(
            TOGGLE_WARP_DRIVE_BINDING_NAME,
            BindingDescription::new("Toggle ZYH Drive")
    ...
    app.register_editable_bindings([
        ...
        EditableBinding::new(
            ...
            BindingDescription::new("Open Settings: About")
                .with_custom_description(bindings::MAC_MENUS_CONTEXT, "About ZYH"),
