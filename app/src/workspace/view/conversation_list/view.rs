        ...
        match action {
            ConversationListViewAction::DeleteConversation {
                ...
                let conversation_title = self
                    ...
                    .unwrap_or_else(|| tr_cached(Message::WorkspaceConversation).to_string());
            ...
            ConversationListViewAction::ToggleOverflowMenu {
                ...
                if is_open_for_same_conversation {
                    ...
                    let mut delete_item = MenuItemFields::new(tr_cached(Message::WorkspaceDelete))
                    ...
                    if !entry.capabilities.can_delete {
                        delete_item = delete_item
                            .with_tooltip(tr_cached(Message::ConversationCannotBeDeleted));
                    }
                    ...
                    let fork_items: Option<[MenuItem<ConversationListViewAction>; 2]> =
                        ...
                        if entry.capabilities.can_fork_locally {
                            Some([
                                MenuItemFields::new(tr_cached(Message::ConversationForkInNewPane))
                                    ...
                                    .into_item(),
                                MenuItemFields::new(tr_cached(Message::ConversationForkInNewTab))
                                    .with_on_select_action(
                                        ConversationListViewAction::ForkConversation {
                                            conversation_id,
            ...
            ConversationListViewAction::ToggleViewAll => {
                ...
                let label = if self.view_all {
                    tr_cached(Message::CommonShowLess)
                } else {
                    view_all_label()
                };
