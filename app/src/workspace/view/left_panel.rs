        ...
        match view {
            ToolPanelView::ProjectExplorer => {
                ...
                ToolbeltButtonConfig {
                    icon: Icon::FileCopy,
                    active_icon: None,
                    tooltip_text: tr_cached(Message::WorkspaceProjectExplorer).to_string(),
            ...
            ToolPanelView::GlobalSearch { .. } => {
                ...
                ToolbeltButtonConfig {
                    icon: Icon::Search,
                    active_icon: None,
                    tooltip_text: tr_cached(Message::WorkspaceGlobalSearch).to_string(),
            ...
            ToolPanelView::WarpDrive => {
                ...
                ToolbeltButtonConfig {
                    icon: Icon::WarpDrive,
                    active_icon: None,
                    tooltip_text: tr_cached(Message::SettingsSectionWarpDrive).to_string(),
            ...
            ToolPanelView::ConversationListView => {
                ...
                ToolbeltButtonConfig {
                    ...
                    tooltip_text: tr_cached(Message::WorkspaceAgentConversations).to_string(),
