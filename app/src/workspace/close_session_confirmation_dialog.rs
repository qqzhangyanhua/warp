...
impl View for CloseSessionConfirmationDialog {
    ...
    fn render(&self, app: &AppContext) -> Box<dyn Element> {
        ...
        let dont_show_again_checkbox = appearance
            ...
            .with_label(Span::new(
                tr(app, Message::WorkspaceDontShowAgain),
                Default::default(),
            ))
        ...
        let close_session_button = appearance
            ...
            .with_centered_text_label(tr(app, Message::WorkspaceCloseSession).into())
        ...
        let cancel_button = appearance
            ...
            .with_centered_text_label(tr(app, Message::WorkspaceCancel).into())
            .with_style(button_style)
            .build()
            .with_cursor(Cursor::PointingHand)
            .on_click(move |ctx, _, _| {
        ...
        let dialog = Container::new(
            Dialog::new(
                tr(app, Message::WorkspaceCloseSessionQuestion).into(),
                Some(tr(app, Message::WorkspaceCloseSharedSessionDescription).into()),
                UiComponentStyles {
                    width: Some(460.),
