...
pub fn search_placeholder_text() -> &'static str {
    tr_cached(Message::KeybindingsSearchPlaceholder)
}
...
impl KeybindingRow {
    ...
    fn render_clicked(
        ...
        let conflict_warning = if has_conflicting_binding {
            render_text(
                tr_cached(Message::KeybindingsShortcutConflictWarning),
        ...
        let press_new_shortcut_text = render_text(
            tr_cached(Message::KeybindingsPressNewShortcut),
            None,
            appearance,
        );
    ...
    fn get_edit_button_row(&self, appearance: &Appearance, index: usize) -> Box<dyn Element> {
        ...
        if self.binding.trigger.is_some() {
            let clear = Hoverable::new(
                ...
                |state| {
                    render_button(
                        tr_cached(Message::KeybindingsClear),
                        appearance,
        ...
        let clear = Container::new(
            Hoverable::new(
                ...
                |state| {
                    render_button(
                        tr_cached(Message::KeybindingsDefault),
                        appearance,
                        self.get_button_text_color(appearance, state),
                    )
                },
            ...
            Hoverable::new(
                ...
                |state| {
                    ...
                    if index == 0 {
                        SavePosition::new(
                            render_button(
                                tr_cached(Message::KeybindingsCancel),
                                appearance,
                                cancel_button_color,
                            ),
        ...
        let save = Container::new(
            Hoverable::new(self.mouse_state_handles.save_mouse_state.clone(), |state| {
                render_button(
                    tr_cached(Message::KeybindingsSave),
                    appearance,
                    self.get_button_text_color(appearance, state),
                )
            })
...
impl KeybindingsWidget {
    fn render_description(
        ...
        let mut description = Flex::column().with_child(render_text(
            tr_cached(Message::KeybindingsDescription),
            Some(UiComponentStyles {
                ...
                Wrap::row()
                    .with_child(
                        Container::new(render_text(
                            tr_cached(Message::KeybindingsUse),
                            Some(UiComponentStyles {
                                font_size: Some(font_size),
                                font_color: Some(
                                    appearance
                    ...
                    .with_child(
                        Container::new(render_text(
                            tr_cached(Message::KeybindingsReferenceInSidePane),
                            Some(UiComponentStyles {
                                font_size: Some(font_size),
                                font_color: Some(
                                    appearance
    ...
    fn render(
        ...
        Flex::column()
            ...
            .with_child(render_columns(
                Container::new(render_text(
                    tr_cached(Message::KeybindingsCommand),
                    Some(UiComponentStyles {
