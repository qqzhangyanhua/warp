...
pub fn init_actions_from_parent_view<T: Action + Clone>(
    ...
    app.register_fixed_bindings(vec![FixedBinding::empty(
        tr_cached(Message::AppearanceStartInputAtTop).to_string(),
        builder(SettingsAction::AppearancePageToggle(
    ...
    app.register_fixed_bindings(vec![FixedBinding::empty(
        tr_cached(Message::AppearancePinInputToTop).to_string(),
        builder(SettingsAction::AppearancePageToggle(
            AppearancePageAction::SetInputMode {
    ...
    app.register_fixed_bindings(vec![FixedBinding::empty(
        tr_cached(Message::AppearancePinInputToBottom).to_string(),
        builder(SettingsAction::AppearancePageToggle(
            AppearancePageAction::SetInputMode {
    ...
    app.register_fixed_bindings(vec![FixedBinding::empty(
        tr_cached(Message::AppearanceToggleInputMode).to_string(),
        builder(SettingsAction::AppearancePageToggle(
        ...
        toggle_binding_pairs.push(
            ToggleSettingActionPair::custom(
                SettingActionPairDescriptions::new(
                    tr_cached(Message::AppearanceShowCodeReviewButtonInTabBar),
                    tr_cached(Message::AppearanceHideCodeReviewButtonInTabBar),
                ),
                builder(SettingsAction::AppearancePageToggle(
    ...
    if FeatureFlag::FullScreenZenMode.is_enabled() {
        ...
        app.register_fixed_bindings([
            FixedBinding::empty(
                tr_cached(Message::AppearanceAlwaysShowTabBar).to_string(),
                builder(SettingsAction::AppearancePageToggle(
            ...
            .with_group(bindings::BindingGroup::Settings.as_str()),
            FixedBinding::empty(
                tr_cached(Message::AppearanceHideTabBarIfFullscreen).to_string(),
                builder(SettingsAction::AppearancePageToggle(
                    AppearancePageAction::SetWorkspaceDecorationVisibility(
            ...
            .with_group(bindings::BindingGroup::Settings.as_str()),
            FixedBinding::empty(
                tr_cached(Message::AppearanceOnlyShowTabBarOnHover).to_string(),
                builder(SettingsAction::AppearancePageToggle(
                    AppearancePageAction::SetWorkspaceDecorationVisibility(
...
impl SettingsWidget for LanguageWidget {
    ...
    fn render(
        ...
        let dropdown_subtext = (*LocalizationSettings::as_ref(app).locale_preference
            == LocalePreference::System)
            .then(|| {
                let system_display_message = match crate::i18n::system_locale() {
                    crate::i18n::Locale::ZhCn => {
                        Message::SettingsLanguageSystemDisplaysSimplifiedChinese
                    }
                    crate::i18n::Locale::En => Message::SettingsLanguageSystemDisplaysEnglish,
                };
                Container::new(
                    FormattedTextElement::from_str(
                        tr(app, system_display_message),
                        appearance.ui_font_family(),
                        appearance.ui_font_size(),
                    )
                    .with_color(appearance.theme().disabled_ui_text_color().into_solid())
...
impl SettingsWidget for InputTypeWidget {
    ...
    fn render(
        ...
        render_body_item::<AppearancePageAction>(
            tr(app, Message::SettingsInputType).into(),
            None,
            LocalOnlyIconState::Hidden,
            ToggleState::Enabled,
            appearance,
...
impl SettingsWidget for InputModeWidget {
    ...
    fn render(
        ...
        render_dropdown_item(
            appearance,
            tr(app, Message::SettingsInputPosition),
            None,
            None,
            LocalOnlyIconState::for_setting(
...
impl SettingsWidget for DimInactivePanesWidget {
    ...
    fn render(
        ...
        render_body_item::<AppearancePageAction>(
            tr(app, Message::SettingsDimInactivePanes).into(),
            None,
            LocalOnlyIconState::for_setting(
...
impl SettingsWidget for FocusFollowsMouseWidget {
    ...
    fn render(
        ...
        render_body_item::<AppearancePageAction>(
            tr(app, Message::SettingsFocusFollowsMouse).into(),
            None,
            LocalOnlyIconState::for_setting(
...
impl SettingsWidget for CompactModeWidget {
    ...
    fn render(
        ...
        render_body_item::<AppearancePageAction>(
            tr(app, Message::SettingsCompactMode).into(),
            None,
            LocalOnlyIconState::for_setting(
                Spacing::storage_key(),
...
impl SettingsWidget for JumpToBottomOfBlockWidget {
    ...
    fn render(
        ...
        let enabled = block_list_settings
            ...
            .value();
        render_body_item::<AppearancePageAction>(
            tr(app, Message::SettingsShowJumpToBottomOfBlockButton).into(),
            None,
            LocalOnlyIconState::for_setting(
...
impl SettingsWidget for ShowBlockDividersWidget {
    ...
    fn render(
        ...
        render_body_item::<AppearancePageAction>(
            tr(app, Message::SettingsShowBlockDividers).into(),
            None,
            LocalOnlyIconState::for_setting(
...
impl TerminalFontWidget {
    fn render_line_height_editor(
        ...
        line_height.add_child(
            appearance
                .ui_builder()
                .label(tr_cached(Message::AppearanceLineHeight).to_string())
                .with_style(UiComponentStyles {
                    margin: Some(Coords {
                        left: 12.,
                        ..Default::default()
        ...
        line_height.add_child({
            let button = appearance
                ...
                .with_text_label(
                    crate::i18n::tr_cached(crate::i18n::Message::SettingsResetToDefault)
                        .to_string(),
                );
...
impl SettingsWidget for TerminalFontWidget {
    ...
    fn render(
        ...
        font_weight.add_child(
            appearance
                .ui_builder()
                .label(tr_cached(Message::AppearanceFontWeight).to_string())
                .with_style(UiComponentStyles {
                    font_size: Some(CONTENT_FONT_SIZE),
                    ..Default::default()
                })
        ...
        font_size.add_child(
            appearance
                .ui_builder()
                .label(tr_cached(Message::AppearanceFontSizePx).to_string())
                .with_style(UiComponentStyles {
                    margin: Some(Coords {
                        left: 2.,
                        ..Default::default()
...
impl SettingsWidget for LigaturesWidget {
    ...
    fn render(
        ...
        render_body_item::<AppearancePageAction>(
            tr(app, Message::SettingsShowLigaturesInTerminal).into(),
            Some(AdditionalInfo {
...
impl SettingsWidget for CursorTypeWidget {
    ...
    fn render(
        ...
        render_body_item::<AppearancePageAction>(
            tr(app, Message::SettingsCursorType).into(),
            None,
            LocalOnlyIconState::for_setting(
...
impl SettingsWidget for BlinkingCursorWidget {
    ...
    fn render(
        ...
        render_body_item::<AppearancePageAction>(
            tr(app, Message::SettingsBlinkingCursor).into(),
            None,
            LocalOnlyIconState::for_setting(
                CursorBlinkEnabled::storage_key(),
                CursorBlinkEnabled::sync_to_cloud(),
...
impl SettingsWidget for TabIndicatorWidget {
    ...
    fn render(
        ...
        render_body_item::<AppearancePageAction>(
            tr(app, Message::SettingsShowTabIndicators).into(),
            None,
            LocalOnlyIconState::for_setting(
...
impl SettingsWidget for CodeReviewButtonWidget {
    ...
    fn render(
        ...
        render_body_item::<AppearancePageAction>(
            tr(app, Message::SettingsShowCodeReviewButton).into(),
            None,
            LocalOnlyIconState::for_setting(
...
impl SettingsWidget for PreserveActiveTabColorWidget {
    ...
    fn render(
        ...
        render_body_item::<AppearancePageAction>(
            tr(app, Message::SettingsPreserveActiveTabColorForNewTabs).into(),
            None,
            LocalOnlyIconState::for_setting(
...
impl SettingsWidget for VerticalTabsWidget {
    ...
    fn render(
        ...
        render_body_item::<AppearancePageAction>(
            tr(app, Message::SettingsUseVerticalTabLayout).into(),
            None,
            LocalOnlyIconState::for_setting(
...
impl SettingsWidget for ShowVerticalTabPanelInRestoredWindowsWidget {
    ...
    fn render(
        ...
        render_body_item::<AppearancePageAction>(
            tr(app, Message::SettingsShowVerticalTabsPanelInRestoredWindows).into(),
            None,
            LocalOnlyIconState::for_setting(
...
impl SettingsWidget for HideTitleBarSearchBarInVerticalTabsWidget {
    ...
    fn render(
        ...
        render_body_item::<AppearancePageAction>(
            tr(app, Message::SettingsHideSearchBarInVerticalTabLayout).into(),
            None,
            LocalOnlyIconState::for_setting(
...
impl SettingsWidget for UseLatestUserPromptAsConversationTitleInTabNamesWidget {
    ...
    fn render(
        ...
        render_body_item::<AppearancePageAction>(
            tr(app, Message::SettingsUseLatestUserPromptAsConversationTitleInTabNames).into(),
            None,
            LocalOnlyIconState::for_setting(
...
impl SettingsWidget for ZenModeWidget {
    ...
    fn render(
        ...
        render_dropdown_item(
            appearance,
            tr(app, Message::AppearanceShowTabBar),
            None,
            None,
            LocalOnlyIconState::for_setting(
