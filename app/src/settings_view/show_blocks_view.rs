...
impl UserOwnedBlock {
    ...
    fn copy_link_button(&self, appearance: &Appearance, block_url: String) -> Box<dyn Element> {
        let button = appearance
            ...
            .with_text_label(tr_cached(Message::ReferralsCopyLink).into());
    ...
    fn link_text(&self, appearance: &Appearance, block_url: String) -> Box<dyn Element> {
        if self.unshare_request_status == UnshareBlockRequestState::InFlight {
            appearance
                .ui_builder()
                .label(tr_cached(Message::SharedBlocksDeleting))
                .with_style(
...
impl ShowBlocksView {
    pub fn new(block_client: Arc<dyn BlockClient>, ctx: &mut ViewContext<Self>) -> Self {
        let menu = ctx.add_typed_action_view(|ctx| {
            ...
            menu.set_items(
                vec![MenuItem::Item(
                    MenuItemFields::new(tr_cached(Message::SharedBlocksUnshare))
            ...
            Container::new(
                Flex::column()
                    .with_child(
                        Align::new(
                            ui_builder
                                .label(tr_cached(Message::SharedBlocksUnshareBlock))
                                .with_style(UiComponentStyles {
                    ...
                    .with_child(
                        Container::new(
                            ui_builder
                                .paragraph(tr_cached(Message::SharedBlocksUnshareConfirmation))
                                .with_style(UiComponentStyles {
                                ...
                                Flex::row()
                                    .with_child(
                                        ui_builder
                                            ...
                                            .with_text_label(
                                                tr_cached(Message::WorkspaceCancel).into(),
                                            )
                                            .build()
                                            .on_click(|ctx, _, _| {
                                    ...
                                    .with_child(
                                        Container::new(
                                            ui_builder
                                                ...
                                                .with_text_label(
                                                    tr_cached(Message::SharedBlocksUnshare).into(),
                                                )
                                                .build()
                                                .on_click(|ctx, _, _| {
                                                    ctx.dispatch_typed_action(
