...
lazy_static! {
    static ref REWARDS: Vec<Reward> = vec![
        Reward {
            ...
            icon_width: 64.,
            icon_height: 64.,
            label: Message::ReferralsRewardExclusiveTheme,
        },
        Reward {
            ...
            icon_width: 56.,
            icon_height: 56.,
            label: Message::ReferralsRewardKeycapsStickers,
        },
        Reward {
            ...
            icon_width: 64.,
            icon_height: 64.,
            label: Message::ReferralsRewardTShirt,
        },
        Reward {
            ...
            icon_width: 64.,
            icon_height: 64.,
            label: Message::ReferralsRewardNotebook,
        },
        Reward {
            ...
            icon_width: 64.,
            icon_height: 64.,
            label: Message::ReferralsRewardBaseballCap,
        },
        Reward {
            ...
            icon_width: 64.,
            icon_height: 64.,
            label: Message::ReferralsRewardHoodie,
        },
        Reward {
            ...
            icon_width: 48.,
            icon_height: 48.,
            label: Message::ReferralsRewardPremiumHydroFlask,
        },
        Reward {
            ...
            icon_width: 50.,
            icon_height: 50.,
            label: Message::ReferralsRewardBackpack,
        },
    ];
}
...
impl ReferralsPageView {
    pub fn new(referrals_client: Arc<dyn ReferralsClient>, ctx: &mut ViewContext<Self>) -> Self {
        ...
        let page = PageType::new_monolith(
            ...
            Some(tr_cached(Message::ReferralsInviteFriendToWarp)),
            true,
        );
        Self {
            page,
        ...
        match &self.api_state {
            ...
            ApiState::Ready { referral_info, .. } => {
                ...
                ctx.emit(ReferralsPageEvent::ShowToast {
                    message: tr_cached(Message::ReferralsLinkCopied).to_owned(),
    ...
    fn handle_send_email_invite_response(
        ...
        match response {
            Ok(successful) => {
                ...
                ctx.emit(ReferralsPageEvent::ShowToast {
                    message: tr_cached(Message::ReferralsEmailSuccess).to_owned(),
            ...
            Err(err) => {
                ...
                ctx.emit(ReferralsPageEvent::ShowToast {
                    message: tr_cached(Message::ReferralsEmailFailure).to_owned(),
                    flavor: ToastFlavor::Error,
                });
            }
        }
...
impl EmailValidationError {
    ...
    fn ui_message(&self) -> String {
        match self {
            EmailValidationError::Empty => tr_cached(Message::ReferralsEmailEmpty).to_owned(),
            EmailValidationError::Invalid(invalid_email) => {
                tr_cached(Message::ReferralsEmailInvalid).replace("{email}", invalid_email)
            }
        }
    }
}
...
impl ReferralsWidget {
    ...
    fn render_link_row(
        ...
        let (link_text, button_enabled) = match &view.api_state {
            ...
            ApiState::Loading => (tr_cached(Message::ReferralsLoading).into(), false),
            ApiState::Failed => (tr_cached(Message::ReferralsFailedToLoadCode).into(), false),
        };
        ...
        Container::new(
            Flex::row()
                ...
                .with_child(self.render_button(
                    button_enabled,
                    tr_cached(Message::ReferralsCopyLink),
    ...
    fn render_email_row(
        ...
        let (button_text, button_enabled) = match &view.api_state {
            ApiState::Ready {
                email_state: SendEmailState::Idle,
                ..
            } => (tr_cached(Message::ReferralsSend), true),
            ApiState::Ready {
                email_state: SendEmailState::Sending,
                ..
            } => (tr_cached(Message::ReferralsSending), false),
            _ => (tr_cached(Message::ReferralsSend), false),
        };
    ...
    fn render_send_invite_section(
        ...
        Flex::column()
            .with_child(
                Container::new(self.render_label(tr_cached(Message::ReferralsLink), appearance))
                    .with_padding_top(PAGE_PADDING)
                    .finish(),
            )
            .with_child(self.render_link_row(view, appearance))
            .with_child(self.render_label(tr_cached(Message::ReferralsEmail), appearance))
        ...
        Flex::column()
            .with_child(
                Container::new(
                    appearance
                        .ui_builder()
                        .span(tr_cached(Message::ReferralsSignUpToParticipate))
                        .with_style(UiComponentStyles {
    ...
    fn render_rewards_section(
        ...
        rewards_section.add_child(
            Container::new(
                appearance
                    .ui_builder()
                    .span(tr_cached(Message::ReferralsRewardIntro))
                    .with_style(UiComponentStyles {
    ...
    fn render_claimed_referrals_count(
        ...
        let current_referrals_label = match claimed_count {
            1 => tr_cached(Message::ReferralsCurrentReferral),
            _ => tr_cached(Message::ReferralsCurrentReferrals),
        };
