...
impl AuthOverrideWarningBody {
        ...
        match self.confirmation_step {
            AuthOverrideConfirmationStep::Initial => {
                let description = Container::new(
                    ui_builder
                        .paragraph(tr(app, Message::AuthOverrideWarningDescription))
                ...
                let export = Container::new(
                    Flex::row()
                        .with_child(
                            ui_builder
                                .link(
                                    tr(app, Message::AuthExportYourData).into(),
                                    None,
                                    Some(Box::new(|ctx| {
                        ...
                        .with_child(
                            ui_builder
                                .span(tr(app, Message::AuthToImportLater))
                                .with_style(muted_styles)
                                .build()
                                .finish(),
                        )
            ...
            AuthOverrideConfirmationStep::ConfirmChangeUser => {
                let confirmation = Container::new(
                    ui_builder
                        .paragraph(tr(app, Message::AuthThisCannotBeUndone))
                        .with_style(muted_styles)
                        .build()
                        .finish(),
                )
    ...
    fn render_buttons(
        ...
        let cancel_button = ui_builder
            ...
            .with_centered_text_label(tr(app, Message::AuthCancel).into())
            .build()
        ...
        let continue_button = ui_builder
            ...
            .with_centered_text_label(tr(app, Message::AuthContinue).into())
            .build()
            .on_click(move |ctx, _, _| {
...
impl View for AuthOverrideWarningBody {
    ...
    fn accessibility_contents(&self, _: &AppContext) -> Option<AccessibilityContent> {
        Some(AccessibilityContent::new(
            "New login detected",
            "ZYH has detected a new login from a web browser. Press escape to cancel and continue using ZYH without login.",
