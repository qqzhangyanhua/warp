    ...
    A: Action + Clone,
{
    ...
    let text = tr(app, Message::AuthOfflineRequiredFirstTime);
    ...
    let button = ui_builder
        ...
        .with_centered_text_label(tr(app, Message::AuthLearnMore).into())
        .build()
    ...
    A: Action + Clone,
{
    ...
    let paragraph_1 = tr(app, Message::AuthOfflineFeaturesWork);
    let paragraph_2 = tr(app, Message::AuthOfflineRequireFirstTimeExplanation);
    let paragraph_3 = tr(app, Message::AuthOfflineCloudFeaturesExplanation);
        ...
        Flex::column()
            ...
            .with_child(
                Container::new(
                    appearance
                        .ui_builder()
                        .span(tr(app, Message::AuthUsingWarpOffline))
            ...
            .with_child(render_close_overlay_button(
                ...
                tr(app, Message::AuthDismiss).into(),
                mouse_state_handle,
                action,
            ))
            .finish(),
    ...
    Container::new(
        Flex::column()
            ...
            .with_child(
                Container::new(
                    ui_builder
                        .span(tr(app, Message::AuthPrivacySettings))
                        .with_style(header_styles)
                        .build()
                        .finish(),
                )
...
pub fn render_privacy_settings_toggles<A: Action + Clone + 'static>(
    ...
    let telemetry_description = render_description(
        appearance,
        tr(app, Message::AuthHighLevelFeatureUsage).into(),
    );
    ...
    let telemetry_link = Flex::row()
        .with_child(
            appearance
                .ui_builder()
                .link(
                    tr(app, Message::AuthLearnMore).into(),
    ...
    let cloud_conversation_storage_toggle = Flex::row()
        ...
        .with_child(
            Shrinkable::new(
                1.,
                render_privacy_settings_section_header(
                    tr(app, Message::AuthStoreAiConversations),
                    appearance,
                )
                .finish(),
            )
    ...
    let cloud_conversation_storage_description = render_description(
        ...
        if PrivacySettings::as_ref(app).is_cloud_conversation_storage_enabled {
            tr(app, Message::AuthStoreAiConversationsEnabled)
        } else {
            tr(app, Message::AuthStoreAiConversationsDisabled)
        }
        .into(),
    );
