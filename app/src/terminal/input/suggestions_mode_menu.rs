...
use super::{
    ...
    DYNAMIC_ENUM_MENU_PADDING, DYNAMIC_ENUM_PENDING_MESSAGE, DYNAMIC_ENUM_RUN_MESSAGE,
    HISTORY_DETAILS_VIEW_WIDTH_REQUIREMENT, RUN_DYNAMIC_ENUM_COMMAND_KEYSTROKE,
