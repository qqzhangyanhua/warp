...
impl CloudActionConfirmationDialog {
    ...
    fn title_text(&self) -> String {
        match self.variant {
            ...
            | CloudActionConfirmationDialogVariant::LeaveTeamReloadCredits => {
                tr_cached(Message::TeamsConfirmLeaveTeamTitle).to_string()
            }
            CloudActionConfirmationDialogVariant::DeleteTeam => {
                tr_cached(Message::TeamsConfirmDeleteTeamTitle).to_string()
            }
            CloudActionConfirmationDialogVariant::RemoveTeamMemberReloadCredits => {
                tr_cached(Message::TeamsConfirmRemoveMemberTitle).to_string()
            }
    ...
    fn body_text(&self) -> String {
        match self.variant {
            CloudActionConfirmationDialogVariant::LeaveTeam => {
                tr_cached(Message::TeamsConfirmLeaveTeamBody).to_string()
            }
            CloudActionConfirmationDialogVariant::DeleteTeam => {
                tr_cached(Message::TeamsConfirmDeleteTeamBody).to_string()
            }
            CloudActionConfirmationDialogVariant::LeaveTeamReloadCredits => {
                tr_cached(Message::TeamsConfirmLeaveTeamReloadCreditsBody).to_string()
            }
            CloudActionConfirmationDialogVariant::RemoveTeamMemberReloadCredits => {
                tr_cached(Message::TeamsConfirmRemoveMemberReloadCreditsBody).to_string()
            }
            CloudActionConfirmationDialogVariant::None => String::new(),
        }
    }
    ...
    fn confirm_button_text(&self) -> String {
        match self.variant {
            CloudActionConfirmationDialogVariant::LeaveTeam => {
                tr_cached(Message::TeamsConfirmYesLeave).to_string()
            }
            CloudActionConfirmationDialogVariant::DeleteTeam => {
                tr_cached(Message::TeamsConfirmYesDelete).to_string()
            }
            CloudActionConfirmationDialogVariant::LeaveTeamReloadCredits => {
                tr_cached(Message::TeamsConfirmLeaveTeam).to_string()
            }
            CloudActionConfirmationDialogVariant::RemoveTeamMemberReloadCredits => {
                tr_cached(Message::TeamsConfirmRemoveMember).to_string()
            }
            CloudActionConfirmationDialogVariant::None => String::new(),
        }
    }
...
impl View for CloudActionConfirmationDialog {
    ...
    fn render(&self, app: &AppContext) -> Box<dyn Element> {
        ...
        let cancel_button = appearance
            ...
            .with_text_label(tr_cached(Message::SettingsCancel).into())
            .build()
